...
.link:[ROOT:example$bgdk-app.yaml,window='_blank']
[source,yaml,subs="+macros,attributes+"]
----
...
which contains a new `kustomization.yaml` file specific to this app. This concept is called an **overlay**,
...
.link:[ROOT:example$bgdk/kustomization.yaml,window='_blank']
[source,yaml,subs="+macros,attributes+"]
----
