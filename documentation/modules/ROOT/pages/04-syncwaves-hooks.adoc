...
> NOTE: Argo CD won't apply the next manifest until the previous reports
"healthy".
...
+
--
.link:https://github.com/redhat-scholars/argocd-tutorial/blob/master/documentation/modules/ROOT/examples/minikube/todo/todo-application.yaml[todo-application.yaml,window='_blank']
[source,yaml,subs="+macros,attributes+"]
----
include::ROOT:example$minikube/todo/todo-application.yaml[]
----
...
----
kubectl apply -f documentation/modules/ROOT/examples/minikube/todo/todo-application.yaml 
----
...
+
--
.link:https://github.com/redhat-scholars/argocd-tutorial/blob/master/documentation/modules/ROOT/examples/todo/todo-application.yaml[todo-application.yaml,window='_blank']
[source,yaml,subs="+macros,attributes+"]
----
include::ROOT:example$todo/todo-application.yaml[]
----
...
[source,bash,subs="attributes+,+macros"]
----
kubectl apply -f documentation/modules/ROOT/examples/todo/todo-application.yaml 
----
--
====
