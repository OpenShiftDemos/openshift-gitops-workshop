...
[source,bash,subs="attributes+,+macros"]
----
git clone -b {gitops-revision} --single-branch https://github.com/OpenShiftDemos/openshift-gitops-workshop ~/openshift-gitops-workshop
----
...
[source,bash,subs="attributes+,+macros"]
----
sed 's/$USER/{user}/' ~/openshift-gitops-workshop/documentation/modules/ROOT/examples/bgd-app.yaml | oc apply -n {user}-argocd -f -
----
