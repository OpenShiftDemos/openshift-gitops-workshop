...
[source,bash,subs="attributes+,+macros"]
----
oc get deployment welcome-php -o jsonpath='{.metadata.labels}' -n {user}-bgdk | jq -r
----
...
.link:https://github.com/OpenShiftDemos/openshift-gitops-workshop/blob/{gitops_revision}/documentation/modules/ROOT/examples/bgdk-app.yaml[bgdk-app.yaml,window='_blank']
[source,yaml,subs="+macros,attributes+"]
----
...
.link:https://github.com/OpenShiftDemos/openshift-gitops-workshop/blob/{gitops_revision}/documentation/modules/ROOT/examples/bgdk/kustomization.yaml[kustomization.yaml,window='_blank']
[source,yaml,subs="+macros,attributes+"]
----
...
[source,bash,subs="attributes+,+macros"]
----
sed 's/$USER/{user}/' ~/openshift-gitops-workshop/documentation/modules/ROOT/examples/bgdk-app.yaml | oc apply -n {user}-argocd -f -
----
